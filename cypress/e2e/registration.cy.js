describe("Registration tests", () => {
  ...
  it("Registration Tests", () => {
    ...
    cy.contains("Name required").should(
      "be.visible",
      "have.css",
      "border-color",
      "rgb(255, 0, 0)"
    ...
    cy.contains("Name is invalid").should(
      "be.visible",
      "have.css",
      "border-color",
      "rgb(255, 0, 0)"
  ...
  it("Last Name tests", () => {
    ...
    cy.contains("Last name required").should(
      "be.visible",
      "have.css",
      "border-color",
      "rgb(255, 0, 0)"
    ...
    cy.contains("Last name is invalid").should(
      "be.visible",
      "have.css",
      "border-color",
      "rgb(255, 0, 0)"
  ...
  it("Email test", () => {
    ...
    cy.contains("Email is incorrect").should(
      "be.visible",
      "have.css",
      "border-color",
      "rgb(255, 0, 0)"
    ...
    cy.contains("Email required").should(
      "be.visible",
      "have.css",
      "border-color",
      "rgb(255, 0, 0)"
    ...
    cy.get("#signupEmail")
      .clear()
      .type("ruslan.kornienko.2013@gmail.com")
      .blur();
  });
  ...
  it("Password test", () => {
    ...
    ).should("be.visible", "have.css", "border-color", "rgb(255, 0, 0)");

    cy.get("#signupPassword").clear().blur();
    cy.contains("Password required").should(
      "be.visible",
      "have.css",
      "border-color",
      "rgb(255, 0, 0)"
    ...
    cy.get("#signupPassword")
      .clear()
      .type("LongPassword1234", { sensitive: true })
      .blur();
    cy.contains(
      "Password has to be from 8 to 15 characters long and contain at least one integer, one capital, and one small letter"
    ).should("be.visible", "have.css", "border-color", "rgb(255, 0, 0)");
  ...
  it("RepeatPassword tests", () => {
    cy.contains("Sign up").click();
    cy.get("#signupRepeatPassword")
      .type("Wrong123", { sensitive: true })
      .blur();
    ...
    cy.contains("Re-enter password required").should(
      "be.visible",
      "have.css",
      "border-color",
      "rgb(255, 0, 0)"
  ...
  it("Check registration value", () => {
    cy.contains("Sign up").click();
    cy.get("#signupName").type("Ruslan");
    cy.get("#signupLastName").type("Kornienko");
    cy.get("#signupEmail").type("ruslan.kornienko.2013@gmail.com");
    cy.get("#signupPassword").type("Qwerty123", {
      sensitive: true,
    });
    cy.get("#signupRepeatPassword").type("Qwerty1", {
      sensitive: true,
    });
    ...
    cy.get("#signupRepeatPassword")
      ...
      .type("Qwerty123", { sensitive: true })
      .blur();
    cy.get("#signupRepeatPassword").should("have.value", "Qwerty123", {
      sensitive: true,
    });
